...
const ordinalNumber = ['1st', '2nd', '3rd', '4th', '5th','6th', '7th', '8th', '9th', '10th'];
...
function Index() {
    ...
    const renderForm = () => {
        switch (step) {
            ...
            case 2:
                return <GetValuesForm setStep={prevStep} step={step} ordinalNumber={ordinalNumber} countForm={countForm} count={stepForm+1} changeValues={changeValues}/>
            case 3:
                return <GetBudgetForm setStep={prevStep} step={step} ordinalNumber={ordinalNumber} countForm={countForm} count={stepForm+1} changeBudget={changeBudget}/>
            case 4:
                return <GetDateForm setStep={prevStep} step={step} ordinalNumber={ordinalNumber} countForm={countForm} count={stepForm+1} changeDate={changeDate}/>
            default:
                break;
        }
    }
    return (
        <div style={{width:"300px"}}>
            ...
            <div className="progress-bar-booking">
            <div 
                class="progress mt-3" 
                style={{height:"7px"}}
            >
